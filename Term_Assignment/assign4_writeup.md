...
## Exhibits (For Optimized Simulation)

![Exhibit 2: Profit Graph](Term_Assignment/graphs/profit.png)
`</br>`
...
`</br>`
![Exhibit 3: Wait Times Graph](Term_Assignment/graphs/wait_time.png)
...
`</br>`
![Exhibit 4: File Size Graph](Term_Assignment/graphs/subscriber.png)
...
`</br>`
![Exhibit 5: Order Size Graph](Term_Assignment/graphs/items_ordered.png)
